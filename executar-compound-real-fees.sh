#!/bin/bash
# Script para configurar CompoundHelper e executar compound com fees reais

echo "🔄 Configurando CompoundHelper e Executando Compound com Fees Reais..."
echo ""
...
# Executar script de compound com fees reais
$FORGE_CMD script script/ExecuteCompoundWithRealFees.s.sol \
  --rpc-url $SEPOLIA_RPC_URL \
  --broadcast \
  -vvvv

echo ""
echo "✅ Compound executado com fees reais!"
