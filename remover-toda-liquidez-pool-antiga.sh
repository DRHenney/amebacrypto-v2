...
# Script para remover TODA a liquidez de uma pool antiga
...
echo "🔄 Removendo TODA a liquidez de pool antiga..."
...
/home/derek/.foundry/versions/stable/forge script script/RemoveAllLiquidityFromOldPool.s.sol:RemoveAllLiquidityFromOldPool \
