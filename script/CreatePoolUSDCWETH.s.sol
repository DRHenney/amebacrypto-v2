...
/// @notice Script completo para criar pool USDC/WETH com hook v2
/// @dev Cria pool, configura hook e adiciona liquidez inicial
contract CreatePoolUSDCWETH is Script {
    ...
    function run() external {
        ...
        // Usar fee diferente para criar nova pool com novo hook
        PoolKey memory poolKey = PoolKey({
            currency0: currency0,
            currency1: currency1,
            fee: 3000, // 0.3% (mesmo fee, mas com novo hook)
            tickSpacing: 60,
            hooks: IHooks(hookAddress) // Novo hook v2
        });
        
        PoolId poolId = poolKey.toId();
        
        console2.log("=== Criando Pool USDC/WETH ===");
        ...
        // Step 1: Verificar se pool já existe
        (uint160 sqrtPriceX96,,,) = StateLibrary.getSlot0(poolManager, poolId);
        
        if (sqrtPriceX96 == 0) {
            // Step 2: Inicializar pool
        ...
        // Step 3: Configurar hook
        console2.log("=== Configurando Hook ===");
        
        // Habilitar pool
        hook.setPoolConfig(poolKey, true);
        console2.log("Pool habilitada no hook");
        ...
        // Configurar tick range (full range) - usando tickSpacing 60
        ...
        // Step 4: Adicionar liquidez inicial (opcional)
        // Você pode adicionar liquidez depois se preferir
        console2.log("=== Pool Criada e Configurada ===");
        console2.log("");
        ...
        console2.log("3. Monitorar fees acumuladas");
        console2.log("");
        console2.log("Pool ID:", vm.toString(uint256(PoolId.unwrap(poolId))));
